...
class LivroView {
  ...
  async listarTodos() {
    let resultado = await this.LivroController.livroListar();
  ...
  async cadastrar() {
    ...
    let resultado = await this.LivroController.livroCadastrar(
      nome,
      editora,
      autor,
      genero,
  ...
  async buscarID() {
    ...
    let resultado = await this.LivroController.livroBuscarID(id);
  ...
  async buscarNome() {
    ...
    let resultado = await this.LivroController.livroBuscarNome(nome);
  ...
  async alterar() {
    ...
    let resultado = await this.LivroController.livroBuscarID(idAlterarLivro);
  ...
  async apagar() {
    ...
    let resultado = await this.LivroController.livroBuscarID(id_remover_livro);
